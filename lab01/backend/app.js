...
app.post("/upload",function(req,res){
    ...
    var insert_sql="";
    insert_sql = "INSERT INTO lab01 (name,category,description,price, image) VALUES ('"+post_data.name +"','"+post_data.category+"','"+post_data.description+"','"+post_data.price+"','"+post_data.image+"');";
...
app.post("/update",function(req,res){
    ...
    if (post_data.image!== undefined){
        update_sql="update lab01 set name ='"+post_data.name+"',price ='"+
                    post_data.price+"',category ='"+ post_data.category
                    +"',description ='" +post_data.description+"',image='"+
                    post_data.image+"' where id =" +post_data.id+";";
